!(function () {
  ...
  function g(e, t, n, i) {
    ...
    0 == n.length
      ...
      : 1 == n.length &&
        (r.push(p(new CSSUnitValue(0, "percent"), e, t, s)), (a = !1));
        ...
        t(n, [
          ...
          },
          {
            ...
            get: function () {
              if ("inactive" === this.phase) return null;
              for (
                var e = this.source, t = this.subject, n = 0, i = 0, r = t;
                r && r != e;
    ...
    if (e.timeline) {
      ...
      if (i && null != e.startTime && !e.proxy.pending) {
        ...
        r > 0 && i >= a
          ...
          : 0 != r &&
            (t && null !== e.holdTime && (e.startTime = A(e, e.holdTime)),
            (e.holdTime = null));
      }
      U(e),
  ...
  function F(e, t) {
    if (e.timeline) {
      ...
      null != r && ((e.startTime = r), (e.holdTime = null), O(e)),
        y(e.timeline, e.animation, L.bind(e.proxy)),
    ...
    if (null != e) {
      ...
      if ("running" == n || "finished" == n) {
        ...
        (t.animation.currentTime =
          (i - R(t, this.startTime)) * this.playbackRate),
  ...
  var _ = new WeakMap(),
    D = (function () {
      ...
      return (
        ...
        (n.reverse = function () {
          ...
          if (!e.timeline || !r)
            return (
              r && (e.pendingPlaybackRate = -M(e)), void e.animation.reverse()
            );
        ...
        t(e, [
              ...
              if (t != e) {
                ...
                if ((l && v(r.timeline, r.animation), s)) {
                  ...
                  switch (n) {
                    ...
                    case "finished":
                      (r.startTime = c),
                        y(r.timeline, r.animation, L.bind(this));
                      break;
                    case "paused":
                ...
                if ((v(r.timeline, r.animation), (r.timeline = null), l))
                  switch (
                    (null !== i && (r.animation.currentTime = o * j(r)), n)
                  ) {
                    case "paused":
                      r.animation.pause();
                      break;
          ...
          },
          {
            ...
            get: function () {
              ...
              if (
                ...
                return "paused";
              if (null != t) {
                if (e.animation.playbackRate > 0 && t >= j(e))
                  return "finished";
          ...
          },
          {
            ...
            get: function () {
              ...
              return e.timeline
                ? (e.readyPromise ||
                    ((e.readyPromise = new E()), e.readyPromise.resolve(this)),
          ...
          },
          {
            ...
            set: function (e) {
              ...
              for (var n = [[], [], [], []], i = 0; i < t.length; i++) {
                ...
                for (var a = z[t.length - 1][i], o = 0; o < a.length; o++)
    ...
    B = {
      ...
      ELEMENT_OFFSET:
        /selector\(#([^)]+)\)[ ]{0,1}(start|end)*[ ]{0,1}([0-9]+[.]{0,1}[0-9]*)*/,
        ...
        (t.handleScrollTimelineProps = function (e, t) {
          ...
          if (!e.selector.includes("@keyframes")) {
            var i = e.block.contents.includes("animation-name:"),
              ...
              l = [];
            r &&
              (o = this.extractMatches(e.block.contents, B.ANIMATION_TIMELINE)),
              i &&
                (l = this.extractMatches(e.block.contents, B.ANIMATION_NAME)),
              (r && i) ||
                (a &&
                  this.extractMatches(e.block.contents, B.ANIMATION).forEach(
                    function (i) {
    ...
    (c.push({
      ...
      evaluate: function (e, t, n, i) {
        ...
        for (
          ...
          l.push(
            "percent" == (r = o[s])[1]
              ? (r[0] * (s % 2 == 0 ? a.height : a.width)) / 100
              : r[0]
          );
        var u = a.left - l[3],
                      ...
                      if ("none" == t);
                        ...
                        for (
                              ...
                              (i = t
                                ...
                                .map(function (e) {
                                  return (function (e) {
                                    ...
                                    return i && document.getElementById(i[1])
                                      ? n(
                                          {
                          ...
                          if (
                            ...
                            ("none" ==
                              window.getComputedStyle(l.target, null).display ||
                              !X(l.target, e))
                          )
                            return null;
                        }
  ...
  if (!Reflect.defineProperty(window, "Animation", { value: D }))
